...
- **Analytics** — spending charts, category breakdowns, period filters; export to CSV and PDF
...
- **Аналитика** — графики расходов, разбивка по категориям/счетам, история баланса, фильтры по периоду; экспорт в CSV и PDF
...
**Frontend** — React + TypeScript (Vite), TanStack Query, Tailwind CSS, react-i18next. UI in Russian and English.
